...
public class ErrorHandlingIntegrationTest {
  ...
  public void givenErrorReturn_whenUsernamePresent_thenOk() throws IOException {
    ...
    String s = webTestClient.get().uri("/api/endpoint1?name={username}", "Tony")
        .accept(MediaType.TEXT_PLAIN).exchange().returnResult(String.class).getResponseBody()
        .blockFirst();
  ...
  public void givenErrorReturn_whenNoUsername_thenOk() throws IOException {
    ...
    String s = webTestClient.get().uri("/api/endpoint1").accept(MediaType.TEXT_PLAIN).exchange()
  ...
  public void givenResumeFallback_whenUsernamePresent_thenOk() throws IOException {
    ...
    String s = webTestClient.get().uri("/api/endpoint2?name={username}", "Tony")
        .accept(MediaType.TEXT_PLAIN).exchange().returnResult(String.class).getResponseBody()
        .blockFirst();
  ...
  public void givenResumeFallback_whenNoUsername_thenOk() throws IOException {
    String s = webTestClient.get().uri("/api/endpoint2").accept(MediaType.TEXT_PLAIN).exchange()
        .returnResult(String.class).getResponseBody().blockFirst();
  ...
  public void givenResumeDynamicValue_whenUsernamePresent_thenOk() throws IOException {
    ...
    String s = webTestClient.get().uri("/api/endpoint3?name={username}", "Tony")
        .accept(MediaType.TEXT_PLAIN).exchange().returnResult(String.class).getResponseBody()
        .blockFirst();
  ...
  public void givenResumeDynamicValue_whenNoUsername_thenOk() throws IOException {
    String s = webTestClient.get().uri("/api/endpoint3").accept(MediaType.TEXT_PLAIN).exchange()
        .returnResult(String.class).getResponseBody().blockFirst();
  ...
  public void givenResumeRethrow_whenUsernamePresent_thenOk() throws IOException {
    String s = webTestClient.get().uri("/api/endpoint4?name={username}", "Tony")
        .accept(MediaType.TEXT_PLAIN).exchange().returnResult(String.class).getResponseBody()
        .blockFirst();
  ...
  public void givenResumeRethrow_whenNoUsername_thenOk() throws IOException {
    ...
    webTestClient.get().uri("/api/endpoint4").accept(MediaType.TEXT_PLAIN).exchange().expectStatus()
        .isBadRequest().expectHeader().contentType(MediaType.APPLICATION_JSON).expectBody()
        .jsonPath("$.message").isNotEmpty().jsonPath("$.message")
  ...
  public void givenGlobalErrorHandling_whenUsernamePresent_thenOk() throws IOException {
    ...
    String s = webTestClient.get().uri("/api/endpoint5?name={username}", "Tony")
        .accept(MediaType.TEXT_PLAIN).exchange().returnResult(String.class).getResponseBody()
        .blockFirst();
  ...
  public void givenGlobalErrorHandling_whenNoUsername_thenOk() throws IOException {
    webTestClient.get().uri("/api/endpoint5").accept(MediaType.TEXT_PLAIN).exchange().expectStatus()
        .isBadRequest().expectHeader().contentType(MediaType.APPLICATION_JSON).expectBody()
        .jsonPath("$.message").isNotEmpty().jsonPath("$.message")
        .isEqualTo("please provide a name");
